Formula to convert the time Thingspeak to Malaysia (Zone)

=LEFT(a2,19)+TIME(7,0,0)

//format import dari link thingpeak

https://api.thingspeak.com/channels/NUMBERKAMU/feeds.json?
